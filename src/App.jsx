    ...
    <SkeletonTheme>
      ...
      <Routes location={location} key={location.pathname}>
        <Route
          path="/"
          element={
            !currentUser ? <FirstHome /> : <Navigate to="/feed/all-posts" />
          }
        />
        ...
        <Route
          ...
          element={
            !currentUser ? <Navigate to="/login" /> : <GetStartedTopics />
          }
        />
        <Route
          path="/create-post"
          element={!currentUser ? <Navigate to="/login" /> : <CreatePostPage />}
        />
        <Route
          path="/profile/:id"
        ...
        />
        <Route
          path="/U2FsdGVkX18W14So8Z+jlcy7OTyMZ5a1PzX76+R+VnYpiroca"
          element={<AddTopics />}
        />
      </Routes>
    </SkeletonTheme>
